...
- New `annabel` CLI entry point (`php vendor/bin/annabel`) with built-in help output and colorized terminal formatting.
...
- Fixed the middleware execution order so middleware correctly wraps the controller.
